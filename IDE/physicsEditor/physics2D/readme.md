...
滑轮关节模拟了现实生活中的物理滑轮的原理。在滑轮关节中，两个物体之间的总绳索长度不变，其中一个刚体沿着指定的轴线上进行直线运动，另一个刚体被限制在该轴线上的一个点上进行运动。效果如动图22-1所示：
...
##### 4.4.1 自身地面点`selfGroundPoint`、另一地面点`otherGroundPoint`
