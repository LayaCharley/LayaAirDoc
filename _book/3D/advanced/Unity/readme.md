...
![image-20230403200208637](img/image-20230403200208637.png)



#### 3.1.1 节点设置

**忽略未激活节点**：如果勾选此选项，类似图中Camera这类未激活的节点将不会被导出。

![image-20230403201054302](img/image-20230403201054302.png)
...
**自定义导出根目录**：如果勾选此选项，可以设置插件导出的资源路径(文本框填取绝对路径)。

![image-20230403201948291](img/image-20230403201948291.png)
...
![image-20230403202415691](img/image-20230403202415691.png)

**批量导出一级节点**：如果勾选此选项，类似图中这类节点最终导出的为LayaMonkey根节点。

![image-20230403202746868](img/image-20230403202746868.png)
...
![image-20230403203143972](img/image-20230403203143972.png)
...
#### 5.2.1 场景的加载显示
当我们想导出整个场景时，可以选择场景，设置导出路径。导出路径建议设置为在LayaAir IDE项目工程目录下的`assets`文件夹，至于是assets目录下的什么目录，由开发者自行决定。

![](img/2023-04-03-12-49-10.png)
...
#### 5.2.2 预设的加载显示
预设的导出，主要是用于当不需要完整导出使用整个场景，只需要某些节点资源。又或者某些节点资源需要独立导出复用或代码动态使用等需求。

![](img/2023-04-01-15-06-08.png)
