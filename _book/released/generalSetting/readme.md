...
LayaAir3.1.x在3.0.x的基础上，重构了发包流程。新版本支持批量发布、支持API调用、支持插件扩展。
...
目前，目标平台中有九种发布选项，分别为：Web、Android、iOS、抖音小游戏、OPPO小游戏、VIVO小游戏、微信小游戏、小米快游戏、支付宝小游戏。如图2-2所示，选择对应平台后，点击构建即可。
...
还可以点击图2-2中的“构建其它”选项，直接发布为对应的平台。发布后，可以在“查看任务”中，看到发布结果。
...
`允许发布时压缩`：构建发布时，若设置了“压缩JS文件”，则此脚本会被压缩。
