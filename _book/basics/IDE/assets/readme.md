...
如图2-3所示，点击“文件夹”会在assets下创建一个文件夹，并可以修改文件夹名字
...
点击“预制体2D”和“预制体3D”会创建预制体文件

### 2.2.1 预制体2D

如图2-4所示，创建预制体2D后，点击后打开，预制体只包括View，用于2D开发
...
同时，我们也可以更改View组件为Dialog组件，如动图2-5所示
...
如图2-7所示，点击“scene”会在assets下快速创建一个场景
...
如图2-8所示，点击“着色器”会选择创建五种类型的shader文件
...
如图2-10所示，点击“着色器蓝图”会在assets下快速创建一个着色器蓝图文件
...
如图2-12所示，点击“着色器蓝图函数”会在assets下快速创建一个着色器蓝图函数文件

<img src="img/2-12.png" style="zoom:50%;" /> 

（图2-12）

点击蓝图函数文件，可以通过可视化窗口来编辑
...
如图2-14所示，点击“Material”会选择创建八种类型的材质文件
...
如图2-15所示，点击“TexturCube”会在assets下快速创建一个TexturCube文件
...
如图2-18所示，点击“RenderTexture”会在assets下快速创建一个RenderTexture文件
...
如图2-20所示，点击“AvatarMask”会创建AvatarMask文件
...
如图2-21所示，点击“灯光设置”会创建LightingSettings文件
...
如图2-23所示，点击“自动图集设置”会创建AtlasConfig文件
